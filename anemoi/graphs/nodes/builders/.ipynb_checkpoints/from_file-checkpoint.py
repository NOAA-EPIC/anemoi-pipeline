...
class ZarrDatasetNodes(BaseNodeBuilder):
    ...
    def get_coordinates(self) -> torch.Tensor:
        ...
        import pickle
        with open('/pscratch/sd/s/schin/pipeline/anemoi-pipeline/longitudes_radians.pkl', 'wb') as f:
            pickle.dump( self.dataset.longitudes, f)
            
        with open('/pscratch/sd/s/schin/pipeline/anemoi-pipeline/latitudes_radians.pkl', 'wb') as f:
            pickle.dump( self.dataset.latitudes, f)
            
        with open('/pscratch/sd/s/schin/pipeline/anemoi-pipeline/longlat_reshaped_radians.pkl', 'wb') as f:
            pickle.dump(self.reshape_coords(self.dataset.latitudes, self.dataset.longitudes), f)            
