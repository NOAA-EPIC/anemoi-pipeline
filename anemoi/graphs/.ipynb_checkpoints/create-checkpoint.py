...
class GraphCreator:
    ...
    def generate_graph(self) -> HeteroData:
        ...
        for nodes_name, nodes_cfg in self.config.nodes.items():
            ...
            print("*nodes_cfg.node_builder", nodes_cfg.node_builder)
            print("*name=nodes_name", nodes_name)
            print("*nodes_cfg.get('attributes', {})", nodes_cfg.get("attributes", {}))
        ...
        for edges_cfg in self.config.get("edges", {}):
            ...
            print("*edges_cfg.edge_builder", edges_cfg.edge_builder)
            print("*edges_cfg.source_name", edges_cfg.source_name)
            print("*edges_cfg.target_name", edges_cfg.target_name)
            print("*edges_cfg.get('source_mask_attr_name', None)", edges_cfg.get("source_mask_attr_name", None))
            print("*edges_cfg.get('target_mask_attr_name', None)", edges_cfg.get("target_mask_attr_name", None))
            print("*edges_cfg.get('attributes')", edges_cfg.get("attributes"))
