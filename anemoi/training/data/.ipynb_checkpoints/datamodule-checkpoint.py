...
class AnemoiDatasetsDataModule(pl.LightningDataModule):
    ...
    def ds_train(self) -> NativeGridDataset:
        ...
        print("**** FUNCTION OPENING ZARR ARRAY DATA:\n", open_dataset(OmegaConf.to_container(self.config.dataloader.training, resolve=True)))
        print("*** Omega Conf Output: \n", OmegaConf.to_container(self.config.dataloader.training, resolve=True))
    ...
    def _get_dataset(
        ...
        print("*data_reader: \n", data_reader)
        print("*rollout: \n", r)
        print("*multistep: \n", self.config.training.multistep_input)
        print("*timeincrement: \n", self.timeincrement)
        print("*model_comm_group_rank: \n", self.model_comm_group_rank)
        print("*model_comm_group_id: \n", self.model_comm_group_id)
